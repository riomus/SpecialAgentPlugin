...
FMCPResponse FProjectService::HandleRequest(const FMCPRequest& Request, const FString& MethodName, const FMCPRequestContext& Ctx)
{
    if (MethodName == TEXT("get_setting"))
    {
        ...
        TSharedPtr<FJsonObject> Result = FGameThreadDispatcher::DispatchToGameThreadSyncWithReturn<TSharedPtr<FJsonObject>>(
            [Section, Key]() -> TSharedPtr<FJsonObject>
            {
                if (!GConfig)
                {
                    return FMCPJson::MakeError(TEXT("GConfig unavailable"));
                }
    ...
    if (MethodName == TEXT("set_setting"))
    {
        ...
        TSharedPtr<FJsonObject> Result = FGameThreadDispatcher::DispatchToGameThreadSyncWithReturn<TSharedPtr<FJsonObject>>(
            [Section, Key, Value]() -> TSharedPtr<FJsonObject>
            {
                if (!GConfig)
                {
                    return FMCPJson::MakeError(TEXT("GConfig unavailable"));
    ...
    if (MethodName == TEXT("enable_plugin") || MethodName == TEXT("disable_plugin"))
    {
        ...
        TSharedPtr<FJsonObject> Result = FGameThreadDispatcher::DispatchToGameThreadSyncWithReturn<TSharedPtr<FJsonObject>>(
            [PluginName, bEnable]() -> TSharedPtr<FJsonObject>
            {
                FText FailReason;
